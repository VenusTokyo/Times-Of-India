    ...
    <div>
      <div className='footer_container'>
        <div className="footleft">
          ...
          <h5 className="footer_heading" style=" padding-left: 10px;">FOLLOW US ON</h5>
          <table className='footer_socialMediaTable' style="width: 200px;">
            <tr>
          ...
          <h5 className="footer_heading" style="padding-left: 20px;">OTHER TIMES GROUP NEWS SITES</h5>
          <table className='footer_tableMain'>
        ...
        <div class="footmid">
          <h5 className="footer_heading" style=" padding-left: 10px;">POPULAR CATEGORIES</h5>
          <table className='footer_tableMain'>
          ...
          <h5 className="footer_heading" style=" padding-left: 10px;">TOP TRENDS</h5>
          <table className='footer_tableMain'>
            <tr> <td>Sam Currans</td> <td>Covid Cases in India</td> </tr>
            <tr><td>Ind vs Eng 3rd ODI</td><td>Bhai Dooj 2021</td></tr>
            <tr><td>Election News</td><td>Farmers protest</td></tr>
          </table>
        </div>

        <div class="footright">
          <h5 className="footer_heading" style=" padding-left: 20px;">HOT ON WEB</h5>
          <table className='footer_tableMain'>
          ...
          <h5 className="footer_heading" style=" padding-left: 20px;">SERVICES</h5>
          <table className='footer_tableMain'>
